...
This document describes the privacy posture of production version `0.3.2` on `main`. The latest
immutable public GitHub Release is `v0.3.2`, and Chrome Web Store production is published at
`0.3.2`.
